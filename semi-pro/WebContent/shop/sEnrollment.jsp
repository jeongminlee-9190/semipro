...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
	...
	<table>
		<tr>
			...
			<tr>
			<td>상점 전화: </td>
			<td><input type="text" name="sPhone1" id="sPhone1" size="4" maxlength="4"> -
			<input type="text" name="sPhone2" id="sPhone2" size="4" maxlength="4"> -
			<input type="text" name="sPhone3" id="sPhone3" size="4" maxlength="4"></td>
		</tr>
		<tr>
			<td>상점 주소: </td>
		...
		<tr>
			<td colspan="2"><input type="checkbox" id="same_shopinfo">가입시 등록한 정보와 동일</td>
		</tr>
		<tr>
			<td>카테고리: </td>
